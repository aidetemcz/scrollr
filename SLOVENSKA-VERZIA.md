...
Táto vetva obsahuje adaptáciu fiktívnej sociálnej siete Scrollr* pre slovenskú AI olympiádu.
Česká verzia zostáva na hlavnej vetve a na doméne truth-hunters.cz; túto vetvu je potrebné
nasadiť samostatne (napr. GitHub Pages z tejto vetvy + vlastná doména).
...
| # | Čo | Kde |
|---|----|-----|
| 1 | **Doména.** Posty 03, 06 a 11 odkazujú na zástupnú doménu `https://truth-hunters.sk/…`. Po nasadení nahraďte doménu skutočnou (hromadné nahradenie v `posts/03-lost-password.md`, `posts/06-hidden-message.md`, `posts/11-scam.md`). | posts/ |
| 2 | **Skrátený odkaz pre quest 11.** V českej verzii bol odkaz na phishingovú stránku skrytý cez bit.ly. Po nasadení vytvorte skrátený odkaz na `sites/iwant.html` a vložte ho do postu 11 namiesto plnej adresy. | posts/11-scam.md |
| 3 | **Overiť quest 09 (Wayback Machine).** Z tohto prostredia nebol prístup na web.archive.org. Navrhnutý dátum je 21. 5. 2012 ráno (deň po striebre slovenských hokejistov na MS 2012). Otvorte `web.archive.org`, zadajte `sme.sk`, vyberte snímku najbližšiu k 21. 5. 2012 8:00 a podľa skutočnej hlavnej správy upravte možnosti v Tiny. Náhradný tip, ak snímka chýba: 11. 3. 2012 (deň po parlamentných voľbách). | posts/09-wayback-machine.md |
| 4 | **Overiť quest 15 (Google Trends).** Tvrdenie „Košice boli v roku 2025 na Slovensku vyhľadávané viac ako Bratislava“ je navrhnuté ako nepravdivé. Skontrolujte v Google Trends (Slovensko, rok 2025) a podľa výsledku upravte možnosti v Tiny; ak by to nevyšlo, stačí prerobiť obrázok `images/kosice-bratislava.jpg` (zdrojové HTML je v tomto dokumente nižšie). | images/ |
| 5 | **Tiny.** Vytvoriť slovenskú lekciu v Tiny s novými možnosťami odpovedí (návrh nižšie) a novým heslom pre quest 11. | Tiny |
| 6 | **Prezentácia a pracovné listy** k lekcii (PDF/Canva) – preložiť a nahradiť odpovede podľa tabuľky nižšie. | mimo repozitára |
...
- `feed.html`, `index.html`, `truth-hunters-index.html` – preklad rozhrania a uvítacieho okna;
...
- Odstránené české assety, ktoré už nič nepoužíva: `images/bali.jpg`, `images/xcom.png`,
  `images/kocka-pes.jpg`, `images/bonsai-kittens.jpg`, `sites/martin-koubsky.html`.
